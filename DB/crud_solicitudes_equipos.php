<?php
  ...
  switch($opcion) {
    case 1://ALTA
      $sql = " INSERT INTO solicitudes_equipos (estado, observaciones, fecha, nombre, apellido_pa, apellido_ma, dni, celular, telefono, direccion, referencia, razon_social, segmento, campaña, sub_campaña, sede, puesto, equipo_prestamo, solicitante) VALUES ('$estado', '$observaciones', '$fecha', '$nombre', '$apellido_pa', '$apellido_ma', '$dni', '$celular', '$telefono', '$direccion', '$referencia', '$razon_social', '$segmento', '$campaña', '$sub_campaña', '$sede', '$puesto', '$equipo_prestamo', '$solicitante') ";
      $resultado = $conexion->prepare($sql);
      $resultado->execute();
    
      $sql = " SELECT solicitudes_equipos_id, estado, observaciones, fecha, nombre, apellido_pa, apellido_ma, dni, celular, telefono, direccion, referencia, razon_social, segmento, campaña, sub_campaña, sede, puesto, equipo_prestamo, solicitante FROM solicitudes_equipos ORDER BY solicitudes_equipos_id DESC LIMIT 1 ";
      $resultado = $conexion->prepare($sql);
      $resultado->execute();
    ...
    case 2://EDICION
      $sql = " UPDATE solicitudes_equipos SET estado = '$estado', observaciones = '$observaciones', fecha = '$fecha', nombre = '$nombre', apellido_pa = '$apellido_pa', apellido_ma = '$apellido_ma', dni = '$dni', celular = '$celular', telefono = '$telefono', direccion = '$direccion', referencia = '$referencia', razon_social = '$razon_social', segmento = '$segmento', campaña = '$campaña', sub_campaña = '$sub_campaña', sede = '$sede', puesto = '$puesto', equipo_prestamo = '$equipo_prestamo', solicitante = '$solicitante' WHERE solicitudes_equipos_id = '$solicitudes_equipos_id' ";
      $resultado = $conexion->prepare($sql);
      $resultado->execute();
    
      $sql = " SELECT solicitudes_equipos_id, estado, observaciones, fecha, nombre, apellido_pa, apellido_ma, dni, celular, telefono, direccion, referencia, razon_social, segmento, campaña, sub_campaña, sede, puesto, equipo_prestamo, solicitante FROM solicitudes_equipos WHERE solicitudes_equipos_id = '$solicitudes_equipos_id' ";
      $resultado = $conexion->prepare($sql);
      $resultado->execute();
      $data = $resultado->fetchALL(PDO::FETCH_ASSOC);
    break;
