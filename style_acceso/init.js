...
(function($) {
	...
	skel.init({
			...
			pollOnce: true,
			breakpoints: {
				'global':	{ range: '*', href: 'Acceso/content/css/style.css' },
				'desktop':	{ range: '737-', href: 'Acceso/content/css/style-desktop.css', containers: 1200, grid: { gutters: 25 }, viewport: { width: 1080, scalable: false } },
				'mobile':	{ range: '-736', href: 'Acceso/content/css/style-mobile.css', containers: '100%!', grid: { collapse: true, gutters: 15 }, viewport: { scalable: false } }
			}
		});
	*/
		...
		skel.init({
			...
			pollOnce: true,
			breakpoints: {
				'global':	{ range: '*', href: 'http://158.69.241.104:90/Acceso/content/css/style.css' },
				'desktop':	{ range: '737-', href: 'http://158.69.241.104:90/Acceso/content/css/style-desktop.css', containers: 1200, grid: { gutters: 25 }, viewport: { width: 1080, scalable: false } },
				'mobile':	{ range: '-736', href: 'http://158.69.241.104:90/Acceso/content/css/style-mobile.css', containers: '100%!', grid: { collapse: true, gutters: 15 }, viewport: { scalable: false } }
			}
		});
